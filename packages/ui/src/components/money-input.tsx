...
/**
 * Controlled numeric input for monetary values.
 *
 * Values are stored as **minor units** (e.g. cents) to avoid floating-point errors.
 * The displayed value is automatically formatted for the user's locale.
 *
 * @example
 * ```tsx
