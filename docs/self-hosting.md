...
Configure in Dokploy secrets: DATABASE_URL, distinct SESSION_SECRET and TOTP_ENCRYPTION_KEY values of at least 32 characters, FRONTEND_URL, CORS_ALLOWED_ORIGINS, RESEND_API_KEY, EMAIL_FROM, TURNSTILE_ENABLED=true, TURNSTILE_SECRET_KEY, and VITE_TURNSTILE_SITE_KEY.
